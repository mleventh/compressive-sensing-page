  ...
  */
  ...
  ResourceFactory = (function() {
    ...
    ResourceFactory.prototype.modifyPuzletUrl = function(url) {
      ...
      puzletUrl = "file:///Users/Matthew/Documents/compressive-sensing-page/cs-intro-gh-pages%202/index.html#2samples";
  ...
  GitHub = (function() {
    ...
    GitHub.prototype.commitChangedResourcesToRepo = function(callback) {
      var commit, maxIdx, resources,
        _this = this;
      if (!(this.hostname === "file:///Users/Matthew/Documents/compressive-sensing-page/cs-intro-gh-pages%202/index.html#2samples" || this.hostname === "localhost" && this.username && this.key)) {
    ...
    GitHub.prototype.description = function() {
      ...
      if (this.gistId) {
        return description += " [file:///Users/Matthew/Documents/compressive-sensing-page/cs-intro-gh-pages%202/index.html#2samples?gist=" + this.gistId + "]";
      }
    };
  ...
  ImageButton = (function() {
    ...
    function ImageButton(container, src, css, callback) {
      ...
      this.callback = callback;
      this.button = $("<img>", {
        src: "file:///Users/Matthew/Documents/compressive-sensing-page/cs-intro-gh-pages%202/index.html#2samples/puzlet/images/" + this.src,
        height: 20,
        width: 20,
        css: {
          position: "absolute",
  ...
  FavIcon = (function() {
    ...
    function FavIcon() {
      ...
      icon = $("<link>", {
        rel: "icon",
        type: "image/png",
        href: "file:///Users/Matthew/Documents/compressive-sensing-page/cs-intro-gh-pages%202/index.html#2samples/puzlet/images/favicon.ico"
      });
  ...
  ThumbImages = (function() {
    ...
    ThumbImages.prototype.processThumb = function(img) {
      ...
      i.css({
        float: "right",
        cursor: "pointer",
        backgroundImage: "url('file:///Users/Matthew/Documents/compressive-sensing-page/cs-intro-gh-pages%202/index.html#2samples/puzlet/images/UI_171.png')",
